...
public record MonsterStatBlock(MonsterInstance monster, int armorClass, int strength, int strengthModifier,
    ...
    public void toTelnet(TelnetOutput output) {
        ...
        output.write(String.format(
                ...
                Ansi.monster(m.getName()), m.getDescription(), combat.currentHealth(), combat.maxHealth(), armorClass,
                strength, strengthModifier, dexterity, dexterityModifier, constitution, constitutionModifier,
                intelligence, intelligenceModifier, wisdom, wisdomModifier, charisma, charismaModifier));
    }
}
