 ...
 * les objets du domaine ({@code GamePlayer}, {@code RoomInstance},
 * {@code Item}...) — de simples POJO, jamais gérés par Spring — puissent
 * publier un événement depuis une méthode métier sans dépendre d'une injection
 * de constructeur. Initialisé une seule fois au démarrage par
