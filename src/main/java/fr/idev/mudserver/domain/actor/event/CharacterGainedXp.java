 ...
 * (ça dépend de {@code LevelService}/{@code ClassService}, des beans Spring
 * auxquels {@link GamePlayer}, simple POJO, n'a pas accès), mais dans le
 * listener de cet événement.
 */
